 ...
 *
 * The atlas reserves a hundred slots so a capacity keeps the same spot on the grid for as long as the
...
/**
 * Smallest horizontal half-extent the camera will fit to. A lone small capacity would otherwise be
 * pushed into the viewer's face, which reads as a zoom bug rather than as a small capacity.
 */
