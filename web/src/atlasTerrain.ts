 ...
 *
 * The atlas used to draw its databases on nothing: a flat clear colour, a faint helper grid, and a
 ...
 * two thirds of the sheet no database occupies. The database city one level down had exactly this
 ...
 * when a database grows, is added, or is dropped. It is drawn because a map has ground, and the legend
 ...
 * one reason that matters: if the terrain were fitted, adding a database would slide the coastline
 ...
 * ignorance of which databases exist while still never dropping a lake on a town centre — and it
 * stays true however many databases the server turns out to have.
 */
