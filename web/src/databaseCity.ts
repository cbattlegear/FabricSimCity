...
export function accessibleObjectLabel(object: DatabaseCityObject): string {
  ...
  return `${object.schemaName}.${object.name}, ${object.kind}, ${size}, ${indexCount}, ${direct}, ${exposure}. ${object.attributedExposure.rationale}${shared}`
}
 ...
 */
export function attributedAbsenceLabel(object: DatabaseCityObject): string {
