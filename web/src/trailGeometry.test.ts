...
import { ROAD_Y, ROAD_LANE_STEP, ROAD_TOP_Y, TRAIL_Y, VEHICLE_Y } from './DatabaseCityScene'
...
const source = readFileSync(new URL('./DatabaseCityScene.ts', import.meta.url), 'utf8')
